...
/**
 * Servlet implementation class NewProf
 */
@WebServlet("/NewProf")
public class NewProf extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (requestType == null) {
			...
			try {
				...
				PreparedStatement insertStudent = con.prepareStatement(eg.egkath(mitrwo,pass));
