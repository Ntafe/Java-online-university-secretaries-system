...
/**
 * Servlet implementation class ShowLessonGradesServlet
 */
@WebServlet("/ShowLessonGradesServlet")
public class ShowLessonGradesServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ShowLessonGradesServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("<html>");
		out.println("<head><title>Show Lessons Grade</title></head>");
		...
		try {
			...
			out.println("</tr>");  
			PreparedStatement showStudent = con.prepareStatement(professors.showlessongrades(Integer.parseInt(str)));
			...
			while(rs.next()) {
				...
				String GradeCourseStudent = rs.getString("COURSE_has_STUDENTS.GradeCourseStudent");
				String htmlRow = createHTMLRow(CourseTitle,STUDENTS_RegistrationNumber,GradeCourseStudent);
				out.println(htmlRow);
			}
...
private String createHTMLRow(String CourseTitle,String STUDENTS_RegistrationNumber,String GradeCourseStudent) {
